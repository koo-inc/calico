...
public final class Messages {
      ...
      public static final Message CREDIT_CARD_NUMBER = new Message("正しいクレジットカード番号ではありません。");
      
      public static final Message EMAIL = new Message("正しいE-Mailの形式ではありません。");
      ...
      public static final Message URL = new Message("正しいURLではありません。");
      
      public static final Message PHONE_NUMBER = new Message("正しい電話番号ではありません。");
      
      public static final Message HOGE = new Message("ほげ！");
