...
public class Mail {
  ...
  public static class Builder {
    ...
    public Builder to(String address) {
      return to(RandomStringUtils.randomAlphanumeric(20), address, Collections.emptyMap());
    }
    public Builder to(String address, Map<String, String> params) {
      return to(RandomStringUtils.randomAlphanumeric(20), address, params);
    }
    ...
    public Mail build() {
      return build(RandomStringUtils.randomAlphanumeric(20));
    }
