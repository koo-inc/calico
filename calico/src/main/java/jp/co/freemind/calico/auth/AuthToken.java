package jp.co.freemind.calico.auth;
...
import jp.co.freemind.calico.util.CryptoUtil;
...
@Value public class AuthToken {
  ...
  AuthToken(String id, String remoteAddress, String csrfToken, LocalDateTime createdAt) {
  ...
  public static AuthToken of(String value) throws IllegalArgumentException {
    try {
      String decrypted = CryptoUtil.decrypt(value, Env.getSecretToken());
  ...
  public static AuthToken create(String id, String remoteAddress, LocalDateTime createdAt) {
    String csrfToken = RandomStringUtils.randomAlphanumeric(16);
    return new AuthToken(id, remoteAddress, csrfToken, createdAt);
  }
